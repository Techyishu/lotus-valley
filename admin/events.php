            ...
            <form method="POST" class="space-y-4">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" rows="3" class="form-control"
                        placeholder="Event details..."><?php echo $editing ? clean($editing['description']) : ''; ?></textarea>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input type="date" name="event_date" required
                            value="<?php echo $editing ? $editing['event_date'] : ''; ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label class="block font-semibold mb-2 text-gray-700">Time</label>
                        <input type="time" name="event_time"
                            value="<?php echo $editing ? $editing['event_time'] : ''; ?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="location"
                            value="<?php echo $editing ? clean($editing['location']) : ''; ?>"
        ...
        <?php if (empty($events)): ?>
            ...
            <div class="card">
                <div class="card-body text-center py-12">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-2">No Events Scheduled</h3>
                    <p class="text-gray-500">Add upcoming events to keep everyone informed.</p>
                </div>
            </div>
        <?php else: ?>
            <?php foreach ($events as $event): ?>
                <div class="card hover:shadow-lg transition group">
                    <div class="card-body p-0 flex flex-col md:flex-row">
                        <!-- Date Badge -->
                        <div
                            class="bg-primary-50 p-6 flex flex-col items-center justify-center min-w-[100px] border-b md:border-b-0 md:border-r border-gray-100">
                        ...
                        <div class="p-5 flex-grow">
                            ...
                            <div
                                class="flex flex-wrap items-center gap-4 text-xs text-gray-500 mt-3 pt-3 border-t border-gray-100">
                                <?php if ($event['event_time']): ?>
                                    <span class="flex items-center"><i
                                            class="far fa-clock mr-1.5 text-primary-400"></i><?php echo date('g:i A', strtotime($event['event_time'])); ?></span>
                                <?php endif; ?>
                                <?php if ($event['location']): ?>
                                    <span class="flex items-center"><i
                                            class="fas fa-map-marker-alt mr-1.5 text-red-400"></i><?php echo clean($event['location']); ?></span>
                                <?php endif; ?>
                                ...
                                <div class="ml-auto flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    ...
                                    <a href="?delete=<?php echo $event['id']; ?>&token=<?php echo generateCSRFToken(); ?>"
